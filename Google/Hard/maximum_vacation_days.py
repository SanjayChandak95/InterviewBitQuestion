        ...
        def helper(day, curr_city):
            ...
            for next_city in range(n):
                if next_city == curr_city:
                    a = max(a, days[curr_city][day]+helper(day+1, curr_city))
                elif flights[curr_city][next_city] == 1:
                    a = max(a, days[next_city][day]+helper(day+1, next_city))
            # print(day, curr_city, a)
            dp[(day, curr_city)] = a
            return dp[(day, curr_city)]
        return helper(0,0)
